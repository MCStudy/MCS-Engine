...
var canvas = document.getElementById('mcs-engine');
this.mcs = canvas.getContext('2d');
...
var drawInterval = function(){
  mcs.beginPath();
  mcs.clearRect(0, 0, canvas.width, canvas.height);
  mcs.fill();
...
this.Sprite = function(callback){
  ...
  my.animate = function(img, x, y, s, frame, collider){
    ...
    my.renderer(function(){
      ...
      mcs.drawImage(my.ani.img, my.ani.frame*x, my.ani.line*y, x, y, my.ani.x, my.ani.y, my.ani.width, my.ani.height);
      //mcs.strokeRect(my.x, my.y, my.width, my.height);
    });
